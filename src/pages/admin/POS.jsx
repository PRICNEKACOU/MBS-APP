...
export function POS() {
  ...
  if (!currentCycle) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-slate-950 p-8 text-center flex-1 w-full">
  ...
  return (
    <div className="flex h-full lg:h-[100dvh] bg-slate-950 overflow-hidden relative">
      ...
      {/* The Cart Panel */}
      <div className={cn(
        "fixed lg:static inset-y-0 right-0 w-full md:w-96 bg-slate-900 border-l border-slate-800 z-50 flex flex-col transition-transform duration-300 ease-in-out lg:transform-none",
        ...
        {/* Checkout Section */}
        <div className="bg-slate-950 p-4 border-t border-slate-800 pb-safe-bottom lg:pb-4 rounded-t-3xl lg:rounded-none">
          {/* Table Details */}
          <div className="mb-4">
      ...
      {!isCartOpen && (
        <button 
          ...
          className="lg:hidden fixed bottom-20 right-4 h-16 w-16 bg-amber-500 text-slate-950 rounded-full shadow-[0_4px_20px_rgba(245,158,11,0.5)] flex items-center justify-center z-30 transition-transform active:scale-90"
        >
      ...
      {receiptOrder && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm print:p-0 print:bg-transparent print:backdrop-blur-none" style={{ pointerEvents: 'auto' }}>
          <div className="relative bg-white shadow-2xl rounded-2xl print:rounded-none flex flex-col w-[350px] print:w-auto print:shadow-none animate-in fade-in zoom-in-95 overflow-hidden">
            ...
            {/* Scrollable container for screen, fully expanded on print */}
